...
export default function EditSupplierModal({ supplier, onClose, onSuccess }) {
 const [formData, setFormData] = useState({
    ...
    business_context:    supplier.business_context    || '',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    setError(null);
    try {
      const res = await suppliersAPI.update(supplier.supplier_id, formData);
      onSuccess(res.data);
      onClose();
    } catch (err) {
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="cyber-input"
                placeholder="e.g. Textile manufacturer for import deal"
                rows={3}
